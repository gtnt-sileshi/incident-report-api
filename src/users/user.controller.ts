...
const createUserSchema = z.object({
  ...
  role: z.enum(['super_admin', 'national_command', 'regional_dispatcher', 'site_supervisor', 'it_rep', 'invigilator', 'police_liaison', 'power_cluster_officer', 'internet_cluster_officer']),
